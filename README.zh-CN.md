...
**开发任务入口：**[实施计划](tasks/plan.md) · [任务清单](tasks/todo.md)。W-01～W-03 已拆为 24 项任务，另有 [2 个架构前置任务](tasks/architecture.md)，后续保留 6 个阶段项和 9 个检查点；另新增 [13项初期完整诊断任务](tasks/diagnostics.md)，诊断出口是LT-009前置。应用任务全部待实施，从 LT-001 开始。
