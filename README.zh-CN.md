...
**当前阶段：Multica 派生应用已在 Windows 本机原生运行；本地登录、诊断概览及 API/Web 进程自动恢复已验证，完整业务与真实执行器验收仍未完成。** 本仓库管理规格、任务及记录；独立应用 checkout 位于 app/，其代码不随文档仓库推送。详见[本机迁移记录](records/2026-09-13-Windows本机开发环境迁移.md)。
