	...
	r.Group(func(r chi.Router) {
		...
		r.Route("/api/content-topics", func(r chi.Router) {
			...
			r.Route("/{id}", func(r chi.Router) {
				...
				r.Patch("/body", h.PatchContentTopicBody)
				r.Post("/account", h.SetContentTopicAccount)
				r.Post("/sources", h.SetContentTopicSources)
		...
		r.Route("/api/content-search", func(r chi.Router) {
			...
			r.Get("/suggestions/compare", h.CompareContentSearchSuggestions)
		...
		r.Group(func(r chi.Router) {
			...
			r.Route("/api/content-accounts", func(r chi.Router) {
				...
				r.Route("/{id}", func(r chi.Router) {
					...
					r.Get("/profile", h.GetAccountExpressionProfile)
					r.Post("/profile", h.SetAccountExpressionProfile)
