...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"content_account":                    workspaceDelete,
	"content_account_revision":           workspaceDelete,
	"content_artifact":                   workspaceDelete,
	"content_artifact_version":           workspaceDelete,
	"content_brief_revision":             workspaceDelete,
	...
	"content_work":                       workspaceDelete,
	"content_review_request":             workspaceDelete,
	"content_review_transition":          workspaceDelete,
	"content_delivery_task":              workspaceDelete,
	"content_publication_record":         workspaceDelete,
	"content_source":                     workspaceDelete,
	"content_source_snapshot":            workspaceDelete,
	"content_source_revision":            workspaceDelete,
	"content_manual_metric":              workspaceDelete,
	"content_feedback_excerpt":           workspaceDelete,
	"content_import_idempotency":         workspaceDelete,
	"content_marketing_node":             workspaceDelete,
	"content_marketing_node_revision":    workspaceDelete,
	"content_marketing_node_candidate":   workspaceDelete,
	"content_roi_cost_revision":          workspaceDelete,
	"content_roi_lead_revision":          workspaceDelete,
	"content_roi_touch_revision":         workspaceDelete,
	"content_roi_deal_revision":          workspaceDelete,
	"content_roi_adjustment_revision":    workspaceDelete,
	"content_roi_cost_allocation":        workspaceDelete,
	"content_roi_attribution_revision":   workspaceDelete,
	"content_roi_import_batch":           workspaceDelete,
	"content_roi_import_claim":           workspaceDelete,
	...
	"content_search_suggestion_revision": workspaceDelete,
	"content_search_suggestion_decision": workspaceDelete,
	"content_search_suggestion_effect":   workspaceDelete,
