...
- [ ] No [NEEDS CLARIFICATION] markers remain
      — **未勾**：Q1～Q8 待主控裁定（spec 文末「待裁决」），每题已给推荐值；裁决后勾上并把「待裁决」改为「裁决记录」。
...
| D14-V05 | 全部 | FR-040～FR-045、FR-060～FR-069；SC-004～SC-008；T017～T019、T065～T074；U-19、U-24～U-33 |
| D14-V08 | **部分**：服务端链路自动化；浏览器闭环手验；真实联网本版不适用 | SC-014；T079；U-40；spec「D14-V08 覆盖说明」 |
